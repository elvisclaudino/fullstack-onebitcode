...
console.log("M\xE9dia Aritm\xE9tica Simples: ".concat(everage(3, 6, 10, 9)));
...
var median = function median() {
  ...
  var secondeMedia = orderedNumbers[middle];
  return everage(firstMedian, secondeMedia);
};
